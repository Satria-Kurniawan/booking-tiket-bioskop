                    ...
                    <div class="card-body">
                        <form action="{{ url('update-film/'.$datafilm->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="judul" name="judul" placeholder="Enter judul" value="{{$datafilm['judul']}}">
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_tayang" class="form-label">Tanggal Tayang :</label>
                                <input type="date" class="form-control" id="tanggal_tayang" name="tanggal_tayang" value="{{$datafilm['tanggal_tayang']}}">
                            </div>
                            <div class="mb-3">
                                <label for="waktu_tayang" class="form-label">Waktu Tayang :</label>
                                <input type="time" class="form-control" id="waktu_tayang" name="waktu_tayang" value="{{$datafilm['waktu_tayang']}}">
                            </div>
                            <div class="form-group">
